...
This project aims to analyze historical loan data to identify key factors
that contribute to loan default risk and provide actionable insights
to support better lending decisions.
## 2.Business Context
This analysis aims to identify key factors associated with loan default risk using historical loan data.
The objective is to understand borrower and loan characteristics that contribute most significantly to default behavior, providing insights to support credit risk assessment and monitoring.
